...
![FLAtlas V2 preview](https://github.com/flathack/FLAtlas-V2/releases/download/v0.8.0.5/PREVIEW.png)

## Download

The easiest way to get FLAtlas V2 is the latest GitHub release.
...
FLAtlas V2 is built for modders who want to work directly with Freelancer data without jumping between too many small tools.
...
This GitHub repository is the public download and release hub for FLAtlas V2 users.

Freelancer is a game by Digital Anvil and Microsoft. FLAtlas V2 is a community modding tool and is not affiliated with or endorsed by Microsoft.
